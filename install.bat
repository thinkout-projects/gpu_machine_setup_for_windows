...
SETX /m CUDA_VER_PATH_NAME2 "11_2"
SET TMP_COMMAND=SETX /m CUDA_PATH_V%CUDA_VER_PATH_NAME2% "%%CUDA_ROOT%%%CUDA_VER_PATH_NAME%"
%TMP_COMMAND%
...
IF %TMP_COUNT% equ 0 (
SETX PATH /M "%%MINICONDA_PATH%%;%%CUDA_PATH%%\bin;%%CUDA_PATH%%\libnvvp;%PATH%"
)
) ELSE (
