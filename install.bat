...
%TMP_WORD%
SETX /M PATH "%INSTALL_DRIVE%\tools\miniconda3\condabin;%INSTALL_DRIVE%\tools\miniconda3\Scripts;%INSTALL_DRIVE%\tools\miniconda3\Library\bin;%INSTALL_DRIVE%\tools\miniconda3;%PATH%"
SET PATH "%INSTALL_DRIVE%\tools\miniconda3\condabin;%INSTALL_DRIVE%\tools\miniconda3\Scripts;%INSTALL_DRIVE%\tools\miniconda3\Library\bin;%INSTALL_DRIVE%\tools\miniconda3;%PATH%"
